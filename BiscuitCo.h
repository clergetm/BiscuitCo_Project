...
<<<<<<< Updated upstream
	...
	void insererClient(string, short int, string); // Ajouter un nouveau client � la liste avec nom, num�ro et rue
	...
	// Commandes
	void ajouterCommandeCookies(Commande*); // Ajouter la Commande pass�e en param�tre � la liste des commandes du client
	void supprimerCommandeCookies(Commande*); // R�duire le nombre de cookie de chaque type de cookie
...
=======
	...
	// Commandes
	void ajouterCommandeCookies(Commande*); // Ajouter la Commande passé en paramètre à la liste des commandes du client
...
<<<<<<< Updated upstream
	...
	void insererCookie(string, short int); // Permet d'augmenter le nombre de cookie d�j� command� si le type de cookie existe, sinon on cr�er un nouveau type
	void supprimerCookie(string, short int); // Permet de supprimer le nombre de cookie dans un type

	void meilleurCookie(); // Permet d'afficher le type de cookie avec le total le plus �lev� dans une commande
...
=======
	...
	void supprimerCookie(string, short int); // Permet de supprimer le nombre de cookie dans un type
	void meilleurCookie(); // Permet d'afficher le type de cookie avec le total le plus éleve dans une commande
>>>>>>> Stashed changes
	// Storage
